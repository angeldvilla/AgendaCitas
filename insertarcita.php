                       ...
                       <!-- <div class="row">
                        ...
                        <div id="contenedor">
                            ...
                            <section class="form-register">
                                ...
                                <input class="controls" type="number" name="paciente" id="paciente" placeholder="Ingrese ID de paciente" required="">
                                <input class="controls" type="number" name="doctor" id="doctor" placeholder="Ingrese ID de doctor" required="">
                               ...
                               <!-- <textarea name="notas" rows="10" cols="44" placeholder="Escribe datos de la cita">Escribe datos de la cita</textarea> -->
                                ...
                                <input class="controls" type="date" name="fechacita" id="fechacita" placeholder="Ingrese la fecha de la cita" required="">
                                <input class="controls" type="time" name="horacita" id="horacita" placeholder="Ingrese la hora de la cita"  required="">
                              <!--  <input class="controls" type="text" name="estado" id="estado" placeholder="Ingrese el estado de la cita"required=""> -->
                            
                             <select class="especialidad" name="estado" id="estado">
                                    
                                       <option selected="selected">-- Seleccione estado de la cita --</option> 
