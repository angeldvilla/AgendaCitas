...
<html lang="es">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Ingresar un Paciente</li>
                        </ol>
                        <!--<div class="row">
    ...
    <input class="controls" type="text" name="nombre_paciente" id="nombre_paciente" placeholder="Ingrese su nombre" required="">
