...
<html lang="es">
    ...
    <form method="POST" action="controlador/nuevoreporteclinico.php">
    
    <input class="controls" type="text" name="sede" id="sede" placeholder="Ingrese Sede" required="">
    <input class="controls" type="number" name="nombre_paciente" id="nombre_paciente" placeholder="Ingrese ID Paciente" required="">
...
<!--<select class="especialidad" name="especialidad" id="especialidad">
    ...
    <input class="controls" type="text" name="motivo" id="motivo" placeholder="Ingrese Motivo Cita" required="">
    <input class="controls" type="text" name="antecedentes" id="antecedentes" placeholder="Ingrese Antecedentes" required="">
    <input class="controls" type="text" name="orden" id="orden" placeholder="Ingrese Orden Medica" required="">
    <input class="controls" type="text" name="informe" id="informe" placeholder="Ingrese Informe" required="">
    <input class="controls" type="date" name="fechaingreso" id="fechaingreso" placeholder="Ingrese Fecha Ingreso" required="">
    <input class="controls" type="date" name="fechasalida" id="fechasalida" placeholder="Ingrese Fecha Salida" required="">
