...
$consulta = $mysql->efectuarConsulta("SELECT agendacitas.citas.id_cita, agendacitas.pacientes.nombre_paciente, 
agendacitas.pacientes.apellidos, agendacitas.doctores.nombre_doctor, agendacitas.doctores.apellidos_doctor, agendacitas.citas.fecha_cita, agendacitas.citas.hora_cita, 
agendacitas.citas.estado FROM agendacitas.citas INNER JOIN agendacitas.pacientes 
ON agendacitas.citas.pacientes_id_paciente = agendacitas.pacientes.id_pacientes INNER JOIN
agendacitas.doctores ON agendacitas.citas.doctores_id_doctores = agendacitas.doctores.id_doctores");
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <li class="breadcrumb-item active">Listado de Citas</li>
                            ...
                            <a href="insertarcita.php" class="btn btn-primary">Nueva Cita</a>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <td><input type="button" class="btn btn-primary" onclick="location.href='editarcita.php?id=<?php echo $row['id_cita']?>';" value="Editar">
                                    <a  class="btn btn-danger" href="controlador/borrarcita.php?id=<?php echo $row['id_cita']?>" onclick="return confirm('¿Está seguro que quiere eliminar este usuario?');">Borrar</a>
