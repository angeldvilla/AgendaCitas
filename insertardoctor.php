...
<html lang="es">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Ingresar un Doctor</li>
                        </ol>
                        <!--<div class="row">
    ...
    <input class="controls" type="text" name="nombre_doctor" id="nombre_doctor" placeholder="Ingrese su nombre" required="">
    <input class="controls" type="text" name="apellidos_doctor" id="apellidos_doctor" placeholder="Ingrese su apellido" required="">
    <input class="controls" type="number" name="ID" id="documento" placeholder="Ingrese su número de documento" required="">
    ...
    <select class="especialidad" name="genero" id="genero">
