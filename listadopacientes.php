            ...
            <!--CONTENIDO-->
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <a href="insertarpaciente.php" class="btn btn-primary">Agregar Paciente</a>
                       <!-- <div class="row">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                 ...
                                 <?php while($row = mysqli_fetch_array($consulta)) {?>
                                        ...
                                        <tr>
                                        <th><?php echo $row['id_pacientes'] ?></th>
                                        <th><?php echo $row['nombre_paciente'] ?></th>
                                        <th><?php echo $row['apellidos'] ?></th>
                                        <th><?php echo $row['num_documento'] ?></th>
                                        <th><?php echo $row['genero'] ?></th>
                                        <th><?php echo $row['email'] ?></th>
                                        <th><?php echo $row['telefono'] ?></th>
                                        <th><?php echo $row['medicamentos'] ?></th>
                                        <th><?php echo $row['alergias'] ?></th>
                                        
                                        <td><input type="button" class="btn btn-primary" onclick="location.href='editarpaciente.php?id=<?php echo $row['id_pacientes']?>';" value="Editar">
                                       <a  class="btn btn-danger" href="controlador/borrarpaciente.php?id=<?php echo $row['id_pacientes']?>" onclick="return confirm('¿Está seguro que quiere eliminar este usuario?');">Borrar</a>
