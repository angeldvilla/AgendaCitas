...
$consulta = $mysql->efectuarConsulta("SELECT agendacitas.historia_clinica.id_historia_clinica, 
								agendacitas.historia_clinica.nombre_sede,agendacitas.pacientes.nombre_paciente,agendacitas.pacientes.apellidos,
                                agendacitas.historia_clinica.motivo_cita,
                                agendacitas.historia_clinica.antecedentes, agendacitas.historia_clinica.ordenes_medicas,
                                agendacitas.historia_clinica.informe, agendacitas.historia_clinica.fecha_ingreso, agendacitas.historia_clinica.fecha_salida   
								FROM agendacitas.historia_clinica INNER JOIN agendacitas.pacientes ON 
                                agendacitas.historia_clinica.pacientes_id_pacientes = agendacitas.pacientes.id_pacientes");
            ...
            <!--CONTENIDO-->
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Reportes Clinicos</h1>
					
                        <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Historia Clinica</li>
                        <li class="breadcrumb-item active">Sede</li>
                        </ol>
                        <a href="insertarreporteclinico.php" class="btn btn-primary">Nuevo Reporte</a>
                       <!-- <div class="row">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Reportes Clinicos de las sedes
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <td><?php echo $row['ordenes_medicas'] ?></td>
                                        <td><?php echo $row['informe'] ?></td>
                                        <td><?php echo $row['fecha_ingreso'] ?></td>
                                        <td><?php echo $row['fecha_salida'] ?></td>
                                        <td><input type="button" class="btn btn-primary" onclick="location.href='editarreporte.php?id=<?php echo $row['id_historia_clinica']?>';" value="Editar">
                                    <a  class="btn btn-danger" href="controlador/borrarreporte.php?id=<?php echo $row['id_historia_clinica']?>" onclick="return confirm('¿Está seguro que quiere eliminar este usuario?');">Borrar</a>
                                    </td>
                        ...
                        <a href="reporteusuarios.php" class="btn btn-danger"  value="Exportar a PDF" target="_blank">Exportar a PDF</a>
